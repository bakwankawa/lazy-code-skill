...
**Personal skills live in agent-specific directories (`~/.claude/skills` for Claude Code, `~/.codex/skills` for Codex). In Codex, project skills live in `.codex/skills/`.** 
...
- Project-specific conventions (put in CLAUDE.md for Claude, or `.codex/rules/` for Codex)
