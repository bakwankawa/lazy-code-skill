...
This document targets Anthropic's skill system. The same principles apply in Codex: skills live in `.codex/skills/`, and the description is used for Agent Decides (when to load the skill).
