---
name: jira
description: Natural language interaction with Jira for managing issues, sprints, and workflows using jira CLI or Atlassian MCP. Use when the user mentions Jira tickets, issue keys, sprints, backlogs, or asks to create or modify Jira issues.
---

# Jira Skill

This README is used as a Cursor project skill under `lazy-code-skill/jira` in this repository.
