#!/usr/bin/env bash
# Sync all skills from vercel-labs/agent-skills (main) into this repo's .cursor/skills/vercel-labs/.
# Run from repo root. Does not touch .cursor/skills/lazy-code-skill/, .cursor/skills/superpowers/, or .cursor/skills/anthropic/.
...
UPSTREAM_DIR="${REPO_ROOT}/.cursor/.vercel-labs-upstream"
VERCEL_LABS_SKILLS_DIR="${REPO_ROOT}/.cursor/skills/vercel-labs"
...
echo "Done. .cursor/skills/vercel-labs/ updated from vercel-labs/agent-skills."
