#!/usr/bin/env bash
# Sync all skills from anthropics/skills (main) into this repo's .cursor/skills/anthropic/.
# Run from repo root. Does not touch .cursor/skills/lazy-code-skill/ or .cursor/skills/superpowers/.
...
UPSTREAM_DIR="${REPO_ROOT}/.cursor/.anthropic-upstream"
ANTHROPIC_SKILLS_DIR="${REPO_ROOT}/.cursor/skills/anthropic"
...
echo "Done. .cursor/skills/anthropic/ updated from anthropics/skills."
